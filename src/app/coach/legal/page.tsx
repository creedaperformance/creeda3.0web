...
export default async function CoachLegalPage() {
  ...
  if (profile.role !== 'coach') redirect(`/${profile.role}/dashboard`)
    ...
    <DashboardLayout type="coach" user={profile}>
      <div className="max-w-4xl mx-auto py-6">
        ...
        <p className="mt-2 text-sm text-white/60">
          Manage compliance records, communication consent, and legal data-rights requests.
        </p>
        <div className="mt-6">
          <LegalControlsPanel role="coach" profile={profile} />
        </div>
      </div>
    </DashboardLayout>
  )
